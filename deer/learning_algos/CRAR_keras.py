    ...
    def train(self, states_val, actions_val, rewards_val, next_states_val, terminals_val):
        ...
        if(self.update_counter%500==0):
            ...
            if(Es.ndim==4):
                ...
                print (Es[0],ETs[0],Es_[0])
            pickle.dump(states_val[0], open("dump_states/encoder/s_{}_{}".format(str(int(time.time()/10)), str(self.update_counter)), 'wb+'))
            pickle.dump(Es[0], open("dump_states/encoder/Es_{}_{}".format(str(int(time.time()/10)), str(self.update_counter)), "wb+"))
            print ("R[0]")
            print (R[0])
